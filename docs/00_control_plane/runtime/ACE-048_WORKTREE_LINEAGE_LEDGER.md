...
| Detached `7865` worktree | `cce016bcf2ccc30d712ac65f104a111e056b3caf` | Three-file intermediate runtime candidate plus docs | Duplicate intermediate | Source patch is identical to detached `a985`. Preserve one representative recovery branch and record the other by exact patch identity; do not integrate twice. |
| Detached `a985` worktree | `cce016bcf2ccc30d712ac65f104a111e056b3caf` | Three-file intermediate runtime candidate plus docs | Exact duplicate of `7865` | Preserve as duplicate lineage evidence. Existing `codex/archive/ace-048-intermediate-lifecycle` remains the named archive lineage unless a missing unique diff is discovered. |
