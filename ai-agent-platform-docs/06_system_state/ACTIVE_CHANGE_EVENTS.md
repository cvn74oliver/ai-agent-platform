...
- Status: ACTIVE — the single unpublished candidate build is now the exact next operation.
- Checkpoint Status: continuity checkpoint created; approval and recovered safety truth are propagated before the live data stage.
