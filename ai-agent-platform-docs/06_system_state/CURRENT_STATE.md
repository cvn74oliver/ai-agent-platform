...
- Exact next step: return the separately bounded Stage D runtime/UI integration correction for approval. Publication, Smart Sync, Gmail reindex, deployment, push, local-main promotion, and lineage retirement remain unauthorized.
