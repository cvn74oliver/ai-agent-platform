...
- Exact next step: begin a fresh bounded Management-page discovery/PM-Brief flow, or separately decide non-force remote push/deployment. Worktree retirement is complete; no push, deployment, publication, rebuild, sync, reindex, Supabase mutation, or recovery-branch deletion is authorized.
