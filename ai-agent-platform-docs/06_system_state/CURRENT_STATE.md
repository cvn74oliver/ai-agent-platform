...
- Exact next step: begin the separately bounded Sender Distribution and Pressure Trend linked-surface reconciliation against the same selected `review_unit_id`, while preserving the accepted Cleanup Groups contract as a regression boundary.
