...
- Exact next step: Oliver decision on applying the single additive migration and generating exactly one new unpublished candidate from existing indexed data. No Human Review is useful before candidate data and later UI integration exist.
